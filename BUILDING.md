...
msbuild io2d.sln
```
Please keep in mind that the project is being built with Visual Studio 2017 in this example. If you want to build it with Visual Studio 2019 use the following line:
```
